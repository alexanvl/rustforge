...
fn main() {
    ...
    println!("Camera position: {:?}", perspective_camera.transform.position);
    println!("Camera rotation: {:?}", perspective_camera.transform.rotation);
    ...
    println!("Projection matrix determinant: {:.6}", proj_matrix.determinant());
    println!("View-projection matrix determinant: {:.6}", view_proj_matrix.determinant());
    ...
    println!("Orthographic view matrix determinant: {:.6}", ortho_view_matrix.determinant());
    println!("Orthographic projection matrix determinant: {:.6}", ortho_proj_matrix.determinant());
    ...
    println!("After moving forward 5 units: {:?}", camera.transform.position);
    ...
    println!("After rotating 90° and moving right 3 units: {:?}", camera.transform.position);
}
